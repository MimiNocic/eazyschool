package com.eng.it.eazybytes.eazyschool.controller;

import com.eng.it.eazybytes.eazyschool.model.Courses;
import com.eng.it.eazybytes.eazyschool.model.EazyClass;
import com.eng.it.eazybytes.eazyschool.model.Person;
import com.eng.it.eazybytes.eazyschool.repository.CoursesRepository;
import com.eng.it.eazybytes.eazyschool.repository.EazyClassRepository;
...
public class AdminController {
    ...
    public ModelAndView displayStudents(Model model, @RequestParam int classId, HttpSession session, @RequestParam(value = "error", required=false) String error){
        ...
        if(error != null){
            errorMessage = "Invalid Email enteredd!!";
