package com.eng.it.eazybytes.eazyschool.rest;
...
import com.eng.it.eazybytes.eazyschool.model.Response;
...
public class ContactRestController {
    ...
    public ResponseEntity<Response> saveMsg(@RequestHeader("invocationFrom") String invocationFrom, @Valid @RequestBody Contact contact){
        ...
        response.setStatusMsg("Message saved succesfully");
    ...
    public ResponseEntity<Response> deleteMsg(RequestEntity<Contact> requestEntity){
        ...
        Response response = new Response();
        response.setStatusCode("200");
        response.setStatusMsg("Message deleted succesfully");
        return ResponseEntity
